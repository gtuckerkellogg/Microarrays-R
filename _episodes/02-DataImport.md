...
# Instead, please edit 02-DataImport.md in _episodes_rmd/
...
> > 
> > ~~~
> > Warning in read.affybatch(paste0("data/", list.celfiles("data"))): Incompatible phenoData object. Created a new one.
> > ~~~
> > {: .error}
...
<img src="../fig/rmd-celfile-image-1.png" title="plot of chunk celfile-image" alt="plot of chunk celfile-image" width="612" style="display: block; margin: auto;" />
